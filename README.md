...
1장부터 7장까지 순서대로 읽는 것을 추천합니다.  
개념 → 설치/활성화 → UI 이해 → 시각화 → 계산 → 데이터 준비 → 대시보드 → 공유 흐름으로 이어집니다.
...
- 6장은 Tableau Prep, 7장은 Tableau Desktop과 Tableau Cloud 환경이 있으면 가장 자연스럽게 따라갈 수 있습니다.
...
- [1-5. Tableau 기초](./pages/01-5-tableau-basics-practice.md)
...
- [4-2. 분석을 위한 다양한 기능 활용](./pages/04-2-analysis-features.md)
- [4-3. 이중축을 활용한 시각화](./pages/04-3-dual-axis-visualization.md)
- [4-4. 대시보드 저장 및 공유](./pages/04-4-save-and-share-dashboard.md)
...
- [7-5. Tableau Cloud를 통한 대시보드 공유](./pages/07-5-tableau-cloud-sharing.md)
