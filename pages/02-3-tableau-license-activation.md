...
![태블로 인증 과정](../assets/02-3/01-3-tableau-auth-flow-updated-v2.png)
...
![Cloud 로그인 완료 화면](../assets/02-3/01-3-cloud-login-finish-v2.png)

이 단계가 끝나면 Tableau Cloud 계정 자체는 활성화된 상태가 됩니다.
...
![추가 인증 수단 선택](../assets/02-3/01-3-auth-method-select-v2.png)
...
![Google Authenticator 확인 코드](../assets/02-3/01-3-google-auth-code-v2.png)
...
![Site URL 입력](../assets/02-3/01-3-desktop-site-url-v2.png)
