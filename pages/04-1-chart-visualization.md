...
![막대 차트 예시 이미지 삽입 예정](../assets/04-1/02-1-bar-chart.png)
...
![상단 툴바 활용 이미지 삽입 예정](../assets/04-1/02-1-toolbar-tips.png)
...
![라인 차트 예시 이미지 삽입 예정](../assets/04-1/02-1-line-chart.png)
...
![맵 차트 예시 이미지 삽입 예정](../assets/04-1/02-1-map-chart.png)
...
![계층 개념 이미지 삽입 예정](../assets/04-1/02-1-hierarchy-overview.png)
...
![계층 만들기 드롭 이미지 삽입 예정](../assets/04-1/02-1-hierarchy-drag.png)

![계층 이름 설정 이미지 삽입 예정](../assets/04-1/02-1-hierarchy-name.png)

계층이 생성되면 데이터 패널에서 관련 필드가 하나의 계층 구조로 묶여 표시됩니다.

![계층 생성 결과 이미지 삽입 예정](../assets/04-1/02-1-hierarchy-created.png)

#### 맵 옵션

![맵 옵션 이미지 삽입 예정](../assets/04-1/02-1-map-options.png)
...
![백그라운드 레이어 이미지 삽입 예정](../assets/04-1/02-1-background-layers.png)
...
![파이 차트 예시 이미지 삽입 예정](../assets/04-1/02-1-pie-chart.png)
...
![퀵 테이블 계산 이미지 삽입 예정](../assets/04-1/02-1-quick-table-calculation.png)
...
![트리맵 예시 이미지 삽입 예정](../assets/04-1/02-1-treemap.png)
...
![버블 차트 예시 이미지 삽입 예정](../assets/04-1/02-1-bubble-chart.png)

![워드 클라우드 예시 이미지 삽입 예정](../assets/04-1/02-1-word-cloud.png)
...
![KPI 개념 이미지 삽입 예정](../assets/04-1/02-1-kpi-overview.png)
...
![KPI 총 매출 이미지 삽입 예정](../assets/04-1/02-1-kpi-sales.png)

- KPI 총 매출
- 레이블: 합계(매출)

![KPI 총 수익 이미지 삽입 예정](../assets/04-1/02-1-kpi-profit.png)

- KPI 총 수익
- 레이블: 합계(수익)

![KPI 총 주문 이미지 삽입 예정](../assets/04-1/02-1-kpi-orders.png)
...
![KPI 총 고객 이미지 삽입 예정](../assets/04-1/02-1-kpi-customers.png)
