...
- Tableau의 핵심 기능과 장점을 설명할 수 있습니다.
- Tableau를 활용하는 대표 기업 및 활용 사례를 이해합니다.
- Tableau 제품군과 플랫폼 구조를 파악합니다.
- Tableau 라이선스 종류와 특성을 구분할 수 있습니다.
...
![사용자 친화적 인터페이스 이미지 삽입 예정](../assets/01-2-user-friendly-interface.png)
...
![자유도 높은 시각화 이미지 삽입 예정](../assets/01-2-flexible-visualization.png)
...
![다양한 데이터 소스 연결 이미지 삽입 예정](../assets/01-2-data-connectors.png)
...
![Tableau AI 기능 이미지 삽입 예정](../assets/01-2-tableau-ai.png)
...
![Tableau 커뮤니티 이미지 삽입 예정](../assets/01-2-tableau-community.png)
...
이 절에서는 Tableau가 어떤 도구인지, 어떤 역사와 제품군을 가지고 있는지, 그리고 왜 많은 조직이 Tableau를 선택하는지 살펴보았습니다.

핵심은 다음과 같습니다.

- Tableau는 시각화와 분석을 함께 지원하는 BI 플랫폼입니다.
- Tableau는 Desktop, Prep, Server, Cloud로 이어지는 제품군 구조를 가집니다.
- 사용성, 시각화 자유도, 데이터 연결성, AI 기능, 커뮤니티 측면에서 강점을 가집니다.

다음 절에서는 Tableau Desktop 설치와 라이선스 활성화 과정을 구체적으로 살펴보겠습니다.
