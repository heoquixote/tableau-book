...
![임시 계산 이미지 삽입 예정](../assets/06-1/03-2-temporary-calculation.png)

![계산된 필드 만들기 메뉴 이미지 삽입 예정](../assets/06-1/03-2-calculated-field-editor.png)
...
![행 수준 계산 개념 이미지 삽입 예정](../assets/06-1/03-2-row-level-calculation.png)
...
![집계 수준 계산 개념 이미지 삽입 예정](../assets/06-1/03-2-aggregate-level-calculation.png)
...
![행 수준 vs 집계 수준 비교 이미지 삽입 예정](../assets/06-1/03-2-row-vs-aggregate-comparison.png)
...
![행 수준 계산 결과 이미지 삽입 예정](../assets/06-1/03-2-row-level-result.png)

#### 집계 수준 계산 시

![집계 수준 계산 결과 이미지 삽입 예정](../assets/06-1/03-2-aggregate-level-result.png)
