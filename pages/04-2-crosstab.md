...
![크로스탭 개념 이미지 삽입 예정](../assets/04-2/02-2-crosstab-overview.png)
...
![크로스탭 총계/소계 이미지 삽입 예정](../assets/04-2/02-2-crosstab-totals.png)
...
![테이블 계산 방향 이미지 삽입 예정](../assets/04-2/02-2-table-calculation-direction.png)
...
![히트맵 예시 이미지 삽입 예정](../assets/04-2/02-2-heatmap.png)

![크로스탭 예시 이미지 삽입 예정](../assets/04-2/02-2-text-table.png)
