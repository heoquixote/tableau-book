...
![장치별 레이아웃 설정 예시](../assets/05-3-device-layout.png)
...
![대시보드 크기 설정 예시](../assets/05-3-dashboard-size.png)
...
![바둑판식 배치 예시](../assets/05-3-tiled-example.png)
...
![부동 배치 예시](../assets/05-3-floating-example.png)
...
![레이아웃 컨테이너 구조 예시](../assets/05-3-layout-container-structure.png)
...
![레이아웃 패널 예시](../assets/05-3-layout-pane.png)
...
![Padding과 Margin 차이](../assets/05-3-padding-vs-margin.png)
...
이번 절에서는 Tableau Desktop에서 실제 대시보드를 구성할 때 자주 쓰는 기능을 정리했습니다.

핵심은 다음과 같습니다.

- 장치별 레이아웃은 다양한 화면 환경에 맞게 사용 경험을 조정하는 기능입니다.
- 대시보드 크기 설정은 배포 환경에 따라 고정, 자동, 범위를 선택해야 합니다.
- 바둑판식은 구조 안정성에, 부동은 자유로운 강조 표현에 강합니다.
- 대시보드 개체와 레이아웃 속성은 화면의 뼈대와 가독성을 결정합니다.
- Padding과 Margin을 구분해 써야 레이아웃이 정돈됩니다.

결국 대시보드 구성은 차트를 올리는 작업이 아니라, `정보를 어떤 구조와 환경에서 가장 잘 보이게 할 것인가를 구현하는 작업`입니다.
