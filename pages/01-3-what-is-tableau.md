...
![Tableau 소개 이미지 삽입 예정](../assets/01-3/01-2-tableau-overview.png)
...
![Tableau 역사 이미지 삽입 예정](../assets/01-3/01-2-tableau-history.png)
...
![Tableau 활용 기업 이미지 삽입 예정](../assets/01-3/01-2-tableau-customers.png)
...
![Tableau 제품군 개요 이미지 삽입 예정](../assets/01-3/01-2-tableau-product-suite.png)
...
![Tableau Prep 이미지 삽입 예정](../assets/01-3/01-2-tableau-prep.png)
...
![Tableau Desktop 이미지 삽입 예정](../assets/01-3/01-2-tableau-desktop.png)
...
![Tableau Server and Cloud 이미지 삽입 예정](../assets/01-3/01-2-tableau-server-cloud.png)
...
![Tableau 구조 이미지 삽입 예정](../assets/01-3/01-2-tableau-architecture.png)
