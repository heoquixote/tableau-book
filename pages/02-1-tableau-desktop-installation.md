...
![Tableau Desktop 다운로드 페이지 이미지 삽입 예정](../assets/02-1/01-3-desktop-download-page.png)
...
![버전 선택 이미지 삽입 예정](../assets/02-1/01-3-desktop-version-select.png)
...
![설치 동의 화면 이미지 삽입 예정](../assets/02-1/01-3-desktop-install-agree.png)

`제품 사용 현황 데이터를 보내지 않음`은 선택 사항입니다.

2. 설치가 끝나면 Tableau 등록 양식을 작성합니다.

![등록 양식 이미지 삽입 예정](../assets/02-1/01-3-desktop-registration-form.png)
