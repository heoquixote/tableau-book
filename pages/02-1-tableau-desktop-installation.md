...
![Tableau Desktop 다운로드 페이지](../assets/02-1/02-1-desktop-download-page.png)
...
![버전 선택](../assets/02-1/02-1-desktop-version-select.png)

3. Tableau.com 계정으로 로그인합니다. 계정이 없다면 먼저 계정을 생성합니다.

![Tableau 로그인](../assets/02-1/02-1-desktop-sign-in.png)
...
![운영체제별 다운로드](../assets/02-1/02-1-desktop-os-download.png)

## 3. Tableau Desktop 설치

1. 설치 동의 후 설치를 진행합니다.

![설치 동의 화면](../assets/02-1/02-1-desktop-install-agree.png)

`제품 사용 현황 데이터를 보내지 않음`은 선택 사항입니다.

2. 설치가 끝나면 Tableau 등록 양식을 작성합니다.

![등록 양식](../assets/02-1/02-1-desktop-registration-form.png)
