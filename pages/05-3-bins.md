...
![구간 차원 크기 제안](../assets/05-3/05-3-bin-size-suggestion.png)
...
![히스토그램 예시](../assets/05-3/05-3-histogram.png)
...
![구간 만들기](../assets/05-3/05-3-create-bins-menu.png)

이후 원하는 `구간 크기(Bin Size)`를 입력합니다.

![구간 크기 입력](../assets/05-3/05-3-bin-size-input.png)

그러면 새 구간 필드가 데이터 패널에 생성되고, 이를 활용해 히스토그램을 만들 수 있습니다.

![구간 필드 생성](../assets/05-3/05-3-bin-field-created.png)

마지막으로 다음과 같이 배치하면 앞의 2절에서 본 히스토그램이 완성됩니다.
