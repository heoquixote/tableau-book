...
![KPI 개념](../assets/04-9/04-9-kpi-overview.png)

### 1-1. KPI의 종류

KPI는 보통 균형성과표(BSC, Balanced Scorecard)의 네 가지 관점인 재무, 고객, 내부 프로세스, 학습과 성장으로 나누어 정리합니다.  
최근에는 여기에 사회적 책임 관점을 더해 함께 관리하는 조직도 많습니다.
...
![KPI 총 매출](../assets/04-9/04-9-kpi-sales.png)

- KPI 총 매출
- 레이블: 합계(매출)

![KPI 총 수익](../assets/04-9/04-9-kpi-profit.png)

- KPI 총 수익
- 레이블: 합계(수익)

![KPI 총 주문](../assets/04-9/04-9-kpi-orders.png)
...
![KPI 총 고객](../assets/04-9/04-9-kpi-customers.png)
