...
![논리적 계층과 물리적 계층](../assets/06-2/04-3-logical-vs-physical-layer.png)

![데이터 모델 개요](../assets/06-2/04-3-data-model-overview.png)
...
![데이터 결합 방식 비교](../assets/06-2/04-3-relationship-join-union-blend-table.png)
...
![목표 매출 달성 여부 예시](../assets/06-2/04-3-blending-target-sales-example.png)
...
![통합 문서 합치기 개념](../assets/06-2/04-3-workbook-merge-concept.png)
...
![통합 문서 가져오기 메뉴](../assets/06-2/04-3-import-workbook-menu.png)
...
![워크시트 복사](../assets/06-2/04-3-workbook-copy.png)

가져온 통합 문서의 시트 탭에서 원하는 워크시트나 대시보드를 복사합니다.

#### 3. 현재 통합 문서에 붙여넣기

![워크시트 붙여넣기](../assets/06-2/04-3-workbook-paste.png)
...
![데이터 원본 바꾸기 메뉴](../assets/06-2/04-3-change-data-source-menu.png)
...
![데이터 원본 바꾸기 대화상자](../assets/06-2/04-3-change-data-source-dialog.png)
...
![참조 바꾸기 메뉴](../assets/06-2/04-3-replace-references-menu.png)
...
![참조 바꾸기 대화상자](../assets/06-2/04-3-replace-references-dialog.png)
