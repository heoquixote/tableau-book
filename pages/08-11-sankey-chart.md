...
> 확장 프로그램이 무엇이고 대시보드에 어떻게 추가하는지는 `10-5. Tableau Extension`에서 다룹니다.  
> 특히 사내 환경에서는 확장 프로그램 실행 허용과 allow list 등록이 필요할 수 있으므로, 배포 전에 해당 절의 보안 관련 내용을 함께 확인하시는 것이 좋습니다.
