...
![Tableau Public Edition](../assets/02-2/02-2-public-edition-overview.png)
...
![Public Edition 다운로드 버튼](../assets/02-2/02-2-public-download-button.png)

3. 이동한 페이지에서 필요한 정보를 입력하고 다운로드를 진행합니다.

![Public Edition 정보 입력](../assets/02-2/02-2-public-download-form.png)

4. 설치를 진행합니다.

![Public Edition 설치](../assets/02-2/02-2-public-install.png)

5. 실행이 완료되면 Tableau Public Edition을 사용할 수 있습니다.

![Public Edition 실행 완료](../assets/02-2/02-2-public-launch-finish.png)
