...
![twb와 twbx 차이 이미지 삽입 예정](../assets/07-5/02-4-twb-vs-twbx.png)
...
![PowerPoint 내보내기 이미지 삽입 예정](../assets/07-5/02-4-export-powerpoint.png)
...
![이미지 내보내기 메뉴 이미지 삽입 예정](../assets/07-5/02-4-export-image-menu.png)

![PNG 저장 이미지 삽입 예정](../assets/07-5/02-4-export-image.png)
...
![크로스탭 Excel 내보내기 이미지 삽입 예정](../assets/07-5/02-4-export-crosstab.png)
...
![데이터 추출 만들기 이미지 삽입 예정](../assets/07-5/02-4-create-extract.png)

라이브와 추출의 차이는 뒤 챕터에서 자세히 다루겠지만, 여기서는 Public 게시 전에 추출 전환이 필요할 수 있다는 점만 기억하시면 됩니다.

#### 게시 화면

![Tableau Public 게시 화면 이미지 삽입 예정](../assets/07-5/02-4-public-publish-screen.png)
...
![노션 임베딩 이미지 삽입 예정](../assets/07-5/02-4-notion-embed.png)
