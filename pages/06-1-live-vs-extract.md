...
![라이브와 추출 비교](../assets/06-1/04-2-live-vs-extract.png)
...
![Tableau Public은 추출만 허용](../assets/06-1/04-2-public-extract-only.png)

참고로 Tableau Public에 게시할 때는 `데이터 추출`만 사용할 수 있습니다. Tableau Public은 외부 데이터베이스에 대한 라이브 연결을 허용하지 않기 때문입니다.

### 1-2. 태블로 작업 순서

![Tableau 작업 순서](../assets/06-1/04-2-tableau-order-of-operations.png)

![필터 적용 순서 개요](../assets/06-1/04-2-order-of-operations-simple.png)
...
![증분 새로고침](../assets/06-1/04-2-incremental-refresh.png)
...
![Context 필터와 Top N](../assets/06-1/04-2-context-filter-topn.png)
...
![Context 필터와 FIXED LOD](../assets/06-1/04-2-context-filter-fixed-lod.png)
