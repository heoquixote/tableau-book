...
![대시보드 액션 종류](../assets/07-4/05-4-action-types.png)
...
![필터 동작 편집 대화상자](../assets/07-4/05-4-filter-action-dialog.png)
...
![Viz in Tooltip 삽입 절차](../assets/07-4/05-4-viz-in-tooltip-steps.png)
...
![일별 시트 예시](../assets/07-4/05-4-daily-sheet-example.png)

![Tooltip 편집기에서 시트 삽입](../assets/07-4/05-4-tooltip-editor-sheet-insert.png)
...
![워드클라우드 시트 예시](../assets/07-4/05-4-word-cloud-sheet.png)

![워드클라우드 선택 계산식](../assets/07-4/05-4-word-cloud-calc.png)

![트리맵/워드클라우드 선택 매개변수](../assets/07-4/05-4-parameter-toggle.png)

![Dynamic Zone Visibility 설정](../assets/07-4/05-4-dynamic-zone-visibility-setting.png)
