...
데이터 분석 업무에서 전처리가 차지하는 비중은 매우 큽니다. 업계에서는 흔히 분석 업무 시간의 대부분이 데이터를 정리하고 다듬는 데 쓰이고, 실제 분석과 해석에 쓰이는 시간은 그보다 훨씬 적다고 이야기합니다.  
정확한 비율은 조직과 데이터 상태에 따라 다르지만, 실무 감각으로 보면 크게 다르지 않습니다.  
