...
![Tableau와 Python 연결 개념](../assets/10-1/10-1-1.png)

### 1-1. 구조

![TabPy 동작 구조](../assets/10-1/10-1-2.png)
...
![TabPy SCRIPT 문법 예시](../assets/10-1/10-1-3.png)
...
![TabPy REST API 화면](../assets/10-1/10-1-4.png)

### 2-5. Tableau에서 TabPy 서버 연결

![분석 확장 프로그램 연결 관리 메뉴](../assets/10-1/10-1-5.png)

![분석 확장 프로그램 연결 유형 선택](../assets/10-1/10-1-6.png)

![TabPy 연결 설정 화면](../assets/10-1/10-1-7.png)
...
![P_Cluster Algorithm 매개변수 생성](../assets/10-1/10-1-8.png)

![P_Cluster Numbers 매개변수 생성](../assets/10-1/10-1-9.png)
...
![Prophet 모델 구조](../assets/10-1/10-1-11.png)

### 4-2. P_Periods to Forecast 생성

예측 실습을 위해 `P_Periods to Forecast` 매개변수를 생성해 미래 예측 기간을 제어합니다.

![P_Periods to Forecast 매개변수 생성](../assets/10-1/10-1-12.png)
...
![날짜 스캐폴드 데이터 관계 연결](../assets/10-1/10-1-13.png)
...
![TabPy 시계열 예측 뷰](../assets/10-1/10-1-14.png)
