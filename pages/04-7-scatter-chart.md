...
![스캐터 차트 개념](../assets/04-7/04-7-scatter-overview.png)
...
![스캐터 차트 예시](../assets/04-7/04-7-scatter-chart.png)
...
![측정값 집계 옵션](../assets/04-7/04-7-aggregate-measures.png)
...
![분석 패널 위치](../assets/04-7/04-7-analytics-pane.png)
...
`요약` 그룹의 박스 플롯이 기본 설정으로 바로 추가되는 방식이라면, `사용자 지정` 그룹의 박스 플롯은 수염 범위 같은 기준을 직접 지정한다는 차이가 있습니다.
