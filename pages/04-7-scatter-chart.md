...
![스캐터 차트 개념 이미지 삽입 예정](../assets/04-7/02-2-scatter-overview.png)
...
![스캐터 차트 예시 이미지 삽입 예정](../assets/04-7/02-2-scatter-chart.png)
...
![측정값 집계 옵션 이미지 삽입 예정](../assets/04-7/02-2-aggregate-measures.png)
...
![분석 패널 위치 이미지 삽입 예정](../assets/04-7/02-2-analytics-pane.png)
