...
![더블클릭 시각화 예시 이미지 삽입 예정](../assets/02-1-double-click-chart.png)
...
![드래그 앤 드롭 시각화 예시 이미지 삽입 예정](../assets/02-1-drag-and-drop-chart.png)
...
![표현 방식 패널 이미지 삽입 예정](../assets/02-1-show-me-panel.png)
...
이 절에서는 Tableau에서 자주 사용하는 기본 차트와 KPI 시각화의 원리를 정리했습니다.

핵심은 다음과 같습니다.

- 차트는 예쁘게 만드는 것보다 질문에 맞게 선택하는 것이 우선입니다.
- 막대 차트는 비교, 라인 차트는 추세, 맵은 지역, 파이는 구성비, 트리맵은 많은 범주의 비중 파악에 적합합니다.
- 퀵 테이블 계산은 빠르지만 계산 방향과 기준을 이해해야 실무에서 안전하게 사용할 수 있습니다.
- KPI 카드는 핵심 숫자를 빠르게 전달하는 데 가장 효과적인 시각화입니다.
