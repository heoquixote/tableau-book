...
![대시보드 화면 설계 와이어프레임 예시](../assets/05-2-wireframe-layout.png)
...
![표현 방식 결정 예시](../assets/05-2-expression-methods.png)
...
![차트 선정 예시](../assets/05-2-chart-selection.png)
...
![툴팁 중심 액션 설계 예시](../assets/05-2-action-tooltip.png)
...
![완성된 대시보드 예시](../assets/05-2-dashboard-final-example.png)
...
![계층 설계 예시](../assets/05-2-design-hierarchy.png)
...
![단순성 설계 예시](../assets/05-2-design-simplicity.png)
...
![일관성 설계 예시](../assets/05-2-design-consistency.png)
...
![근접성 설계 예시](../assets/05-2-design-proximity.png)
...
![여백 활용 예시](../assets/05-2-design-whitespace.png)
...
좋은 대시보드는 차트를 예쁘게 배열한 화면이 아니라, `질문을 구조화하고 행동으로 연결하는 화면`입니다.

핵심은 다음과 같습니다.

- 먼저 비즈니스 질문을 정의해야 합니다.
- 화면 설계, 표현 방식, 차트, 액션은 그 질문에 맞춰 결정되어야 합니다.
- AI 도구는 기획 초안과 아이디어 확장에 유용하지만, 최종 판단은 사람이 해야 합니다.
- 디자인 원칙은 미적 요소가 아니라 정보 이해 속도를 높이기 위한 장치입니다.

결국 대시보드 설계는 디자인 작업이면서 동시에 `의사결정 경험을 설계하는 일`입니다.
