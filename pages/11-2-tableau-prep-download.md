...
![Tableau Prep 다운로드 페이지 이미지 삽입 예정](../assets/11-2/11-2-prep-download-page.png)

이 단계에서 Tableau.com 계정 로그인이 필요할 수 있습니다.

#### 2. 운영 체제에 맞는 설치 파일 다운로드

![설치 파일 다운로드 이미지 삽입 예정](../assets/11-2/11-2-prep-download-installer.png)
...
![등록 양식 이미지 삽입 예정](../assets/11-2/11-2-prep-registration-form.png)

설치 후 최초 실행 시 Tableau 등록 양식을 입력할 수 있습니다.

#### 5. 활성화 완료

![활성화 완료 이미지 삽입 예정](../assets/11-2/11-2-prep-activation-complete.png)
